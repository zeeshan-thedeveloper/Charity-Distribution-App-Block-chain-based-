              ...
              ref
                ...
                .once("value", (snapshot) => {
                  ...
                  snapshot.forEach((data) => {
                    storedValue.push(data.val());
                  });
                  storedValue[5] = userCredential.user.uid;
                  ...
                  const dataToSend = {
                    accountCatagory: storedValue[0],
                    blockchainAccountAddress: storedValue[1],
                    email: storedValue[2],
                    firstName: storedValue[3],
                    lastName: storedValue[4],
                    userUid: storedValue[5]
                  };
